...
- fast checks reuse `actions/setup-python` pip caching, and CI preloads a cached `khoj-aio:pytest` image before the integration suite instead of rebuilding it inside every pytest run
